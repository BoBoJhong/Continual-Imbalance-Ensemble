"""
Phase 4 - FS Sweep: 特徵選擇方法 / 保留比例 全面掃描
...
OUTPUT_DIR = project_root / "results" / "phase4_feature"
...
def main():
    logger = get_logger("Phase4_FS_Sweep", console=True, file=True)
    set_seed(42)
    ...
    logger.info("\nPhase 4 FS Sweep 完成。results/phase4_feature/")
