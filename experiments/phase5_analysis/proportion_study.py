"""
Phase 5 - Proportion Study: 新舊資料比例對集成效能的影響
...
def main():
    logger = get_logger("Phase5_ProportionStudy", console=True, file=True)
    set_seed(42)
    ...
    logger.info("\nPhase 5 Proportion Study 完成。results/phase5_analysis/")
