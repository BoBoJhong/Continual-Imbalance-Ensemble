"""
Phase 5 - Split Comparison: Chronological vs Block-CV 切割方式比較
...
OUTPUT_DIR = project_root / "results" / "phase5_analysis"
...
def main():
    logger = get_logger("Phase5_SplitComparison", console=True, file=True)
    set_seed(42)
    ...
    logger.info("\nPhase 5 Split Comparison 完成。results/phase5_analysis/")
