...
def main():
    logger = get_logger("Medical_Ensemble", console=True, file=True)
    set_seed(42)

    logger.info("=" * 80)
    logger.info("實驗 8: Medical Ensemble")
    logger.info("=" * 80)
    ...
    out_csv = out_dir / "medical_ensemble_results.csv"
...
if __name__ == "__main__":
    main()
    print("\n實驗 8 完成！結果在 results/medical/medical_ensemble_results.csv")
