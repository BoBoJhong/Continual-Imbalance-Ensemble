"""
實驗 6: Medical 資料集 - Baseline + Ensemble
...
def main():
    logger = get_logger("Medical_Baseline_Ensemble", console=True, file=True)
    set_seed(42)

    logger.info("=" * 80)
    logger.info("實驗 6: Medical Baseline + Ensemble")
    logger.info("=" * 80)
    ...
    out_csv = out_dir / "medical_baseline_ensemble_results.csv"
...
if __name__ == "__main__":
    main()
    print("\n實驗 6 完成！結果在 results/medical/medical_baseline_ensemble_results.csv")
