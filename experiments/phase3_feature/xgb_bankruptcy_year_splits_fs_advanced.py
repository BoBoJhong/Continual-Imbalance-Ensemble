"""
Phase 3 — Study II: 進階非線性特徵選擇 (Mutual Information & SHAP) 
=============================================================================
基於先前的結論，線性方法 (ANOVA) 無法提升非線性樹狀集成。
我們改用 mutual_info 與 shap，測試是否能維持或優化 AUC 與 Recall。
"""
...
def main():
    logger = get_logger("Phase3_FS_Advanced_XGB", console=True, file=True)
    set_seed(42)
    ...
    logger.info(f"Study II: 進階非線性特徵選擇 × XGBoost 年份切割 — Bankruptcy")
