...
輸出：results/phase3_feature/{mutual_info,shap,rfe}/xgb_medical_fs_full_{static,des}.csv
"""
...
def main():
    ...
    # Save results (split by FS method like bankruptcy triad)
    save_medical_fs_full_split(project_root, static_all, des_all)
    logger.info(f"Done! Medical results saved to method dirs under results/phase3_feature/")
