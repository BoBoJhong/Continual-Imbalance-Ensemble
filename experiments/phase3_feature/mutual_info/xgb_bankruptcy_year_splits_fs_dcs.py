...
from experiments.phase3_feature._core.triad_csv import save_bankruptcy_fs_dcs_split
...
def main():
    ...
    # 儲存結果：三方法子目錄
    save_bankruptcy_fs_dcs_split(project_root, all_rows)
    logger.info(f"\nDCS results saved (split by method): {len(all_rows)} rows")
    logger.info("Done! results/phase3_feature/{mutual_info,shap,rfe}/xgb_bankruptcy_fs_full_dcs.csv")
