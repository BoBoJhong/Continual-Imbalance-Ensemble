"""Phase 2 — XGB Medical：動態 DES。輸出：results/phase2_ensemble/dynamic/des/"""
...
def main():
    logger = get_logger("XGB_Medical_DES_YearSplits", console=True, file=True)
    set_seed(42)

    out = project_root / "results" / "phase2_ensemble" / "dynamic" / "des"
    out.mkdir(parents=True, exist_ok=True)

    _, des_rows = iter_medical_year_splits(logger)
    ...
    logger.info("\n完成。dynamic/des/ xgb_oldnew_ensemble_des_*_medical.csv")
