"""
Phase 2 - Ensemble (過採樣)
使用 oversampling 採樣訓練 Old / New 模型池，比較歷史池、新資料池與組合效果。
...
SPLIT_MODE    = "block_cv"
SAMPLING_TYPE = "oversampling"          # undersampling | oversampling | hybrid
OUTPUT_DIR    = project_root / "results" / "phase2_ensemble"
...
def main():
    ...
    logger.info(f"Phase 2 Ensemble ({SAMPLING_TYPE}) 完成。results/phase2_ensemble/")
