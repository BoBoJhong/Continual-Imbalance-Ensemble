...
def main():
    ...
    if all_parts:
        ...
        logger.info("Saved: results/phase2_ensemble/static/all_combinations_systematic.csv")
        summary = (
        ...
        logger.info("Saved: results/phase2_ensemble/static/all_combinations_best_per_size.csv")
    else:
