...
輸出檔名均附帶 split_mode suffix，例如：
  ...
  results/phase3_dynamic/stock_spx_dcs_comparison_block_cv.csv
  
使用方式：
    python scripts/_run_both_splits.py
    python scripts/_run_both_splits.py --datasets bankruptcy medical
    python scripts/_run_both_splits.py --splits chronological
    python scripts/_run_both_splits.py --phases p1 p3
"""
import sys
import argparse
...
OUT_P3 = project_root / "results" / "phase3_dynamic"
